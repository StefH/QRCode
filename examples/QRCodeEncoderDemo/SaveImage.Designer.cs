namespace QRCodeEncoderDemo
{
	partial class SaveImage
	{
		...
		private void InitializeComponent()
		{
			...
			this.QRImageDimensionLabel = new System.Windows.Forms.Label();
			...
			this.QRCodePosYTextBox = new System.Windows.Forms.TextBox();
			this.label5 = new System.Windows.Forms.Label();
			this.ImageBrowseButton = new System.Windows.Forms.Button();
			this.QRCodePosXTextBox = new System.Windows.Forms.TextBox();
			...
			this.ModuleSizeLabel = new System.Windows.Forms.Label();
			...
			this.ImageFormatComboBox.Location = new System.Drawing.Point(137, 212);
			...
			// 
			// QRImageDimensionLabel
			// 
			this.QRImageDimensionLabel.BackColor = System.Drawing.SystemColors.Info;
			this.QRImageDimensionLabel.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.QRImageDimensionLabel.Location = new System.Drawing.Point(175, 167);
			this.QRImageDimensionLabel.Name = "QRImageDimensionLabel";
			this.QRImageDimensionLabel.Size = new System.Drawing.Size(56, 22);
			this.QRImageDimensionLabel.TabIndex = 7;
			this.QRImageDimensionLabel.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// label1
			// 
			...
			this.label1.Text = "Image dimension (pix)";
			// 
			// label4
			// 
			...
			this.label4.Text = "Module size (pix)";
			// 
			// label7
			// 
			...
			this.label7.Text = "Quiet zone (pix)";
			// 
			// HeaderLabel
			// 
			...
			this.HeaderLabel.Location = new System.Drawing.Point(179, 9);
			this.HeaderLabel.Name = "HeaderLabel";
			this.HeaderLabel.Size = new System.Drawing.Size(210, 32);
			this.HeaderLabel.TabIndex = 0;
			this.HeaderLabel.Text = "Save QR Code Image";
			...
			this.QRCodeDimensionLabel.Location = new System.Drawing.Point(175, 32);
			this.QRCodeDimensionLabel.Name = "QRCodeDimensionLabel";
			this.QRCodeDimensionLabel.Size = new System.Drawing.Size(56, 22);
			this.QRCodeDimensionLabel.TabIndex = 1;
			...
			this.label3.Text = "QR code dimension";
			// 
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.QuietZoneLabel);
			this.groupBox1.Controls.Add(this.ModuleSizeLabel);
			this.groupBox1.Controls.Add(this.QRCodeDimensionLabel);
			this.groupBox1.Controls.Add(this.label3);
			this.groupBox1.Controls.Add(this.QRImageDimensionLabel);
			...
			this.groupBox1.Size = new System.Drawing.Size(246, 265);
			this.groupBox1.TabIndex = 1;
			this.groupBox1.TabStop = false;
			this.groupBox1.Text = "QR Code to Image";
			// 
			...
			this.ImageBGWidthLabel.Name = "ImageWidthLabel";
			...
			this.ImageBGHeightLabel.Name = "ImageHeightLabel";
			...
			this.label6.Text = "QR code center Y position (pix)";
			// 
			// label10
			// 
			...
			// QRCodePosYTextBox
			// 
			this.QRCodePosYTextBox.Location = new System.Drawing.Point(216, 313);
			this.QRCodePosYTextBox.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.QRCodePosYTextBox.Name = "QRCodePosYTextBox";
			this.QRCodePosYTextBox.Size = new System.Drawing.Size(56, 22);
			this.QRCodePosYTextBox.TabIndex = 19;
			this.QRCodePosYTextBox.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// label5
			// 
			...
			this.label5.Text = "QR code center X position (pix)";
			// 
			// ImageBrowseButton
			// 
			...
			// QRCodePosXTextBox
			// 
			this.QRCodePosXTextBox.Location = new System.Drawing.Point(216, 287);
			this.QRCodePosXTextBox.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.QRCodePosXTextBox.Name = "QRCodePosXTextBox";
			this.QRCodePosXTextBox.Size = new System.Drawing.Size(56, 22);
			this.QRCodePosXTextBox.TabIndex = 17;
			this.QRCodePosXTextBox.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// label2
			// 
			...
			this.ImageFileNameTextBox.TabIndex = 10;
			...
			// ModuleSizeLabel
			// 
			this.ModuleSizeLabel.BackColor = System.Drawing.SystemColors.Info;
			this.ModuleSizeLabel.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.ModuleSizeLabel.Location = new System.Drawing.Point(175, 77);
			this.ModuleSizeLabel.Name = "ModuleSizeLabel";
			this.ModuleSizeLabel.Size = new System.Drawing.Size(56, 22);
			this.ModuleSizeLabel.TabIndex = 3;
			this.ModuleSizeLabel.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// QuietZoneLabel
			// 
		...
		private System.Windows.Forms.Label QRImageDimensionLabel;
		...
		private System.Windows.Forms.TextBox QRCodePosYTextBox;
		private System.Windows.Forms.Label label5;
		private System.Windows.Forms.Button ImageBrowseButton;
		private System.Windows.Forms.TextBox QRCodePosXTextBox;
		...
		private System.Windows.Forms.Label ModuleSizeLabel;
		}
}