...
namespace QRCodeDecoderDemo
{
    ...
    public partial class QRCodeDecoderDemo : Form
    {
        ...
        private void OnLoad(object sender, EventArgs e)
        {
            ...
            // create decoder
            var logger = new LoggerFactory().CreateLogger<QRDecoder>();
            QRCodeDecoder = new QRDecoder(logger);
        ...
        private static string QRCodeResult(byte[][] dataByteArray)
        {
            ...
            if (dataByteArray.Length == 1) return ForDisplay(QRDecoder.ByteArrayToString(dataByteArray[0]));
            ...
            for (int Index = 0; Index < dataByteArray.Length; Index++)
            {
                ...
                Str.Append(ForDisplay(QRDecoder.ByteArrayToString(dataByteArray[Index])));
            }
            return Str.ToString();
        }
